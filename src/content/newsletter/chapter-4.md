...
---
The action models you've met so far emit numbers. Symbolic ones emit a name and a list of arguments instead, `pick(block_a)` or `pour(cup_1, bowl_2)`, drawn from a finite alphabet the engineer wrote down ahead of time. This is where the field started, and it's the family every other chapter measures itself against.
